...
#define FLASH_SIZE_UBOOT_BIN	    (1*1024*1024)        /* UBOOT程序 */
#define FLASH_OFFSET_UBOOT_BIN		0
#endif
// start with FLASH_DEVICE_UBOOT_ENV
//do not use in hi3515a
//the math who use it is not used
...
#define FLASH_SIZE_KERNEL	        (4*1024*1024)    /* 内核 */
#define FLASH_OFFSET_KERNEL	    	0

// start with FLASH_DEVICE_ROOTFS
#define FLASH_SIZE_ROOTFS	        (10*1024*1024)    /* 文件系统 */
...
//
char* GetUbootEnv( char* pEnv );//do not use in hi3515a
int SetUbootEnv( char* pEnv );//do not use in hi3515a
// u-boot参数
void EraseUbootEnv();//do not use in hi3515a
