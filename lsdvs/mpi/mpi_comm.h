...
/*******************************************************
    function announce  
*******************************************************/
HI_S32 mpi_comm_sys_get_pic_size(VIDEO_NORM_E enNorm, PIC_SIZE_E enPicSize, SIZE_S *pstSize);
HI_U32 mpi_comm_sys_calcpicVbBlkSize(VIDEO_NORM_E enNorm, PIC_SIZE_E enPicSize, PIXEL_FORMAT_E enPixFmt, HI_U32 u32AlignWidth);
HI_S32 SAMPLE_COMM_SYS_MemConfig(HI_VOID);
HI_VOID SAMPLE_COMM_SYS_Exit(void);
HI_S32 mpi_comm_sys_init(VB_CONF_S *pstVbConf);
...
HI_S32 mpi_comm_vpss_start(HI_S32 s32GrpCnt, SIZE_S *pstSize, HI_S32 s32ChnCnt,VPSS_GRP_ATTR_S *pstVpssGrpAttr);
HI_S32 mpi_comm_vpss_stop(HI_S32 s32GrpCnt, HI_S32 s32ChnCnt) ;
...
HI_S32 mpi_comm_vo_start_devlayer(VO_DEV VoDev, VO_PUB_ATTR_S *pstPubAttr, HI_U32 u32SrcFrmRate);
HI_S32 SAMPLE_COMM_VO_StopDevLayer(VO_DEV VoDev);
HI_S32 mpi_comm_vo_start_channel(VO_DEV VoDev,VO_PUB_ATTR_S *pstPubAttr,SAMPLE_VO_MODE_E enMode);
...
HI_S32 mpi_comm_vo_bind_vi(VO_DEV VoDev, VO_CHN VoChn, VI_CHN ViChn);
...
HI_S32 mpi_comm_vo_get_wh(VO_INTF_SYNC_E enIntfSync,HI_U32 *pu32W,HI_U32 *pu32H,HI_U32 *pu32Frm);
...
HI_S32 mpi_comm_venc_bind_vpss(VENC_GRP GrpChn,VPSS_GRP VpssGrp,VPSS_CHN VpssChn);
HI_S32 mpi_comm_venc_unbind_vpss(VENC_GRP GrpChn,VPSS_GRP VpssGrp,VPSS_CHN VpssChn);
