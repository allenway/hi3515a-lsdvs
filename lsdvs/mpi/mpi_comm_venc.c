...
HI_S32 SAMPLE_COMM_VENC_SnapProcess(VENC_GRP VencGrp, VENC_CHN VencChn, VPSS_GRP VpssGrp, VPSS_CHN VpssChn)
{
    ...
    ******************************************/
    s32Ret = mpi_comm_venc_bind_vpss(VencGrp, VpssGrp, VpssChn);
    if (HI_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("mpi_comm_venc_bind_vpss failed!\n");
        return HI_FAILURE;
    }
    /******************************************
    ...
    ******************************************/
    ...
    /******************************************
     step 6:  unbind
    ******************************************/
    s32Ret = mpi_comm_venc_unbind_vpss(VencGrp, VpssGrp, VpssChn);
    if (HI_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("mpi_comm_venc_unbind_vpss failed!\n");
        return HI_FAILURE;
    }
